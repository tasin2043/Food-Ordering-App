...
const Footer = () => {
  return (
    <div>
      <footer className="footer bg-orange x1:px-24 text-base-content py-5 px-4">
        <aside>
          <img src="/public/foodmood-footer-logo.png" alt="" className="w-40" />
          <p className='font-bold text-[8px] text-black text-center position-absolute -mt-5 mx-11'>Taste your Town</p>
        ...
        <nav>
          ...
          <a className="link link-hover text-white">Menus</a>
      ...
      <footer className="footer bg-black items-center xl:px-24 py-5 px-4">
        ...
        <nav className="grid-flow-col gap-4 md:place-self-center md:justify-self-end">
          ...
          <a>
            <svg
              ...
              height="24"
              viewBox="0 0 24 24"
              className="fill-current text-youtube"
            >
